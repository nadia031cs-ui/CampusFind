    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            email.addEventListener("focus", function () {
                email.style.boxShadow = "0 0 8px var(--color-primary)";
            });
            ...
            password.addEventListener("focus", function () {
                password.style.boxShadow = "0 0 8px var(--color-primary)";
            });
            ...
            remember.addEventListener("change", function () {
                console.log(remember.checked ? "Remember Me Enabled" : "Remember Me Disabled");
            });
            ...
            form.addEventListener("submit", function (event) {
                ...
                if (savedUser.photo) {
                    localStorage.setItem("profileImage", savedUser.photo);
                }

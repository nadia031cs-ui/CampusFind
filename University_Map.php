    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <main>
                ...
                <img src="/Floors/G.F.jpeg" alt="G.F">
            ...
            <aside>
                ...
                <p>
                <ul>
                    <li>Main Entry/Exit</li>
                    
                    <li>Nearby Access to Corridor</li>
                    ...
                    <li>Stairs (Right Side)</li>
                    <li>Room 108 - EEE Lab</li>
                    <li>Canteen (Far Right)</li>
                </ul>
                </p>
